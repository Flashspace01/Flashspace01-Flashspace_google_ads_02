    ...
    <section className="py-20 lg:py-28 bg-muted/20">
      <div className="container mx-auto px-4 lg:px-8">
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-14">
          ...
          <h2 className="text-2xl sm:text-3xl lg:text-4xl font-extrabold text-foreground tracking-tight mb-3">
            Available in <span className="text-primary">25+ States</span> & <span className="text-primary">50+ Cities</span>
          </h2>
          <p className="text-muted-foreground text-base font-normal max-w-lg mx-auto">
        ...
        <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }} transition={{ delay: 0.3 }} className="text-center mt-10">
          <p className="text-sm text-muted-foreground font-normal mb-4">Don't see your city? We cover 25+ states — just ask us.</p>
...
const faqs = [
  ...
  { q: "Which cities are covered?", a: "50+ cities across 25+ states in India — Delhi, Mumbai, Bangalore, Chennai, Hyderabad, Pune, Kolkata, Ahmedabad, Jaipur, Lucknow, Indore, Kochi & many more." },
...
const VirtualOfficeLanding = () => {
  ...
  return (
    <FormDialogContext.Provider value={{ open: openForm }}>
      <Helmet>
        <title>Virtual Office Starting @699/month | FlashSpace</title>
        <meta
          name="description"
          content="Get GST and MCA approved virtual office addresses across India with FlashSpace. Fast setup, premium locations, and affordable plans starting at 699 per month."
        />
      </Helmet>
