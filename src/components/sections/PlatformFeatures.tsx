...
import coworkingIllustrated from "@/assets/ai-workspace-coworking.png";
...
export const PlatformFeatures = () => {
  return (
    <section className="py-24 lg:py-32 bg-background" id="platform">
          ...
          <div className="space-y-16">
            ...
            >
              ...
              <div className="absolute bottom-0 left-0 right-0 p-8 lg:p-12">
                ...
                <Button size="lg" className="bg-white text-foreground hover:bg-white/90 shadow-md font-semibold">
                  Explore workspaces
