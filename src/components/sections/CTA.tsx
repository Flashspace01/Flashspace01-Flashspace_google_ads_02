    ...
    <section className="relative w-full overflow-hidden -mb-px">
      ...
      <div className="relative z-10 py-20 lg:py-28">
        <div className="container mx-auto px-4 lg:px-8">
          ...
          >
            <Button size="lg" className="bg-primary hover:bg-primary/90 text-primary-foreground shadow-md text-base px-8 font-normal">
              Get Started Free
              <ArrowRight className="w-5 h-5 ml-2" />
            </Button>
            <Button size="lg" variant="outline" className="border-primary/30 bg-card/50 backdrop-blur-sm hover:bg-card/70 text-base font-normal">
              Talk to Sales
            </Button>
          </motion.div>
        </div>
