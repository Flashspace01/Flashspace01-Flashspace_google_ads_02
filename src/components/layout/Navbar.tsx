      ...
      <div className="container mx-auto px-4 lg:px-8">
        <nav className="flex items-center justify-between h-16 lg:h-20">
          ...
          <div className="flex items-center gap-2 lg:gap-3">
            <Button variant="outline" size="sm" className="hidden sm:inline-flex border-white/30 text-white hover:bg-white/10 hover:text-white bg-transparent text-sm px-4">
