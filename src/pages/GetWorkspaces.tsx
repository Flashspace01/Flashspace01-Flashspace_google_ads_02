        ...
        <div className="flex-1 min-w-0 flex flex-col gap-2">
          ...
          <div className="flex gap-2 mt-1">
            <button
              ...
              className="py-2 px-4 text-xs font-medium rounded-xl bg-primary text-primary-foreground hover:bg-primary/85 active:bg-primary/75 transition-all duration-200 whitespace-nowrap">

              Get Best Price
            </button>
            <button
              onClick={(e) => {e.stopPropagation();handleNavigate();}}
              className="py-2 px-3 text-xs font-medium rounded-xl border border-primary/30 text-primary hover:bg-primary/5 active:bg-primary/10 transition-all duration-200 flex items-center gap-1 whitespace-nowrap">
    ...
    <div
      ...
      <div className="p-4 flex flex-col flex-1">
        ...
        <div className="flex gap-2 mt-4">
          <button
            onClick={(e) => {e.stopPropagation();handleNavigate();}}
            className="flex-1 py-2.5 text-xs font-medium rounded-xl bg-primary text-primary-foreground hover:bg-primary/85 active:bg-primary/75 transition-all duration-200">

            Get Best Price
          </button>
          <button
            onClick={(e) => {e.stopPropagation();handleNavigate();}}
            className="flex-1 py-2.5 text-xs font-medium rounded-xl border border-primary/30 text-primary hover:bg-primary/5 active:bg-primary/10 transition-all duration-200 flex items-center justify-center gap-1.5">
